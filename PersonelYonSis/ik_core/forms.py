...
class PersonelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'brans': forms.Select(attrs={'class': 'form-select'}),
            ...
            'tahsil_durumu': forms.Select(attrs={'class': 'form-select'}),
            ...
            'ozel_durumu': forms.Select(attrs={'class': 'form-select'}),
...
class GeciciGorevForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'gecici_gorev_tipi': forms.Select(attrs={'class': 'form-select'}),
