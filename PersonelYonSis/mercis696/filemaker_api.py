...
FILEMAKER_SERVER = "https://10.38.12.55"
DATABASE_NAME = "e-Cizelge"
    ...
    for personel in personeller:
        ...
        for mesai in mesai_data:
            schedule_data.append({
                ...
                "PersonelAciklama": personel["Görev Yeri"],
        ...
        for record in records:
            try:
                mesai_tanimlari.append({
                    ...
                    "GunduzMesaisi": record["Gündüz Mesaisi"],
                    "GeceMesaisi": record["Gece Mesaisi"],
                    "AksamMesaisi": record["Akşam Mesaisi"]
                })
